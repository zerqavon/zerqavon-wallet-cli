...
*Setup instructions for a Gitian build of Zerqavon using Docker.*
...
You'll also need to clone the zerqavon repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/monero-project/monero.git
cd zerqavon/contrib/gitian
```
