# Zerqavon Blockchain Stats

Zerqavon Blockchain Stats utlity exports daily statistics for the zerqavon blockchain from creation through current state.

## Usage:

See also the utility's help option. `zerqavon-blockchain-stats --help`
...
- `zerqavon-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `zerqavon-blockchain-stats | save-to-database.sh`
